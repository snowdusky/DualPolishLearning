...
def prepare_coco_data(seed=1, percent=9.0, version=2017, seed_offset=0):
    ...
    # )
    COCOANNODIR = './data/coco/annotations/'
    anno = json.load(open('./data/coco/annotations/semi_supervised/instances_train2017.1@1-unlabeled.json'))

    image_list = anno["images"]
    labeled_tot = int(1 / 11.0 * len(image_list))
    ...
    # )
    save_name = "instances_train2017.1@1-unlabeled-part9"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--percent", type=float, default=9)
