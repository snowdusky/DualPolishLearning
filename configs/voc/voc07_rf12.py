_base_ = "./voc07_base.py"

data_root = '/data0/sunyuxuan/VOC/VOCdevkit/'
img_norm_cfg = dict(
...
data = dict(
    ...
    train=dict(
        ...
        sup=dict(
            type="CocoDataset",
            classes='${CLASSES}',
            ann_file=data_root + 'annos_coco/voc07_trainval.json',
        ...
        unsup=dict(
            type="CocoDataset",
            classes='${CLASSES}',
            ann_file=data_root + 'annos_coco/voc12_trainval.json',
            img_prefix=data_root,
...
lr_config = dict(step=[30000, 40000])
runner = dict(_delete_=True, type="IterBasedRunner", max_iters=45000)
